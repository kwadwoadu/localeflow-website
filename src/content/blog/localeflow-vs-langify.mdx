...
|---------|------------|---------|
| **Pricing** | From $9.99/month | $17.50/month |
...
LocaleFlow offers flexible pricing starting at **$9.99/month** with automatic AI-powered translations included in every plan. There are no word limits or hidden fees for translation.
...
**LocaleFlow** includes AI-powered automatic translation in all plans. When you add or update content, translations are generated automatically using advanced AI models. You can also customize translations with your own term rules and blacklists.
...
Ready to translate your store? [Try LocaleFlow free for 14 days](https://apps.shopify.com/locale-flow).
